...
<div class="grid grid-cols-12 gap-4 mt-4">
    ...
    <x-grafico-barras 
        :datos="$datosGrafico" 
        titulo="Desgaste Promedio por Sensor" 
        tipo="desgaste" 
    />
    
    <x-grafico-barras 
        :datos="$datosGraficoTemperatura" 
        titulo="Temperatura Promedio por Sensor" 
        tipo="temperatura" 
    />
    ...
    <div class="grid col-span-12 space-y-8 mt-4">
        {{-- Anillo Interior --}}
        <div>
            <h2 style="background: #003459;
    padding: 10px;
    border-radius: 5px;
    color: #a6b8c1;
    font-weight: 400;" class="text-xl font-bold mb-4  dark:text-white">Anillo Interior (Sensores 1-5)</h2>
